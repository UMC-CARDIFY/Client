...
const ScheduledLearningItem: React.FC<ScheduledLearningProps> = ({
  ...
  return (
    <div
      className={`w-[16rem] h-[15rem] justify-center px-8 py-6 flex flex-col gap-2 bg-${folderColor}-100 rounded-lg cursor-pointer`}
    >
      ...
      <div className="relative w-52 mt-[22px]">
