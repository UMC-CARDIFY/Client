...
const NoteItem: React.FC<NoteItemProps> = ({ name, createdAt, editDate, flashCardCount, folderColor }) => {
  ...
  return (
    <div className="flex py-[0.5rem] items-center ml-[0.5rem]">
      ...
      <Text variant="sub_heading3" className="flex-grow pl-[1rem] pr-[1.25rem] text-base-black cursor-pointer">
        {name}
      </Text>
      <div className="bg-gray-150 h-[1.5rem] w-[1px]" />
      <Text variant="sub_heading4" className="text-gray-500 pl-[1rem] pr-[1.25rem]">
        {createdAt}
      </Text>
      <div className="bg-gray-150 h-[1.5rem] w-[1px]" />
      <Text variant="sub_heading4" className="text-gray-500 pl-[1rem] pr-[1.25rem]">
