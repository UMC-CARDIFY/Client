...
const NoteItem: React.FC<NoteItemProps> = ({
  ...
  return (
    <div className="flex py-[0.5rem] items-center ml-[0.5rem]">
      ...
      <ArchiveNoteIcon
        className={`w-[1.75rem] h-[1.75rem] mr-[1.5rem] fill-icon-${folderColor}`}
      />
      <div className="bg-gray-150 h-[1.5rem] w-[1px]" />
      <Text
        variant="sub_heading2"
        className="flex-grow pl-[1rem] pr-[1.25rem] text-base-black cursor-pointer"
      >
        {name}
      </Text>
      <div className="bg-gray-150 h-[1.5rem] w-[1px]" />
      <Text
        ...
        className="text-gray-500 pl-[1rem] pr-[1.25rem]"
      >
        {createdAt}
      </Text>
      <div className="bg-gray-150 h-[1.5rem] w-[1px]" />
